...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    Route::post('saveGender', 'UserController@saveGender');
    Route::post('saveBMI', 'UserController@saveBMI');
    ...
    Route::group(['namespace' => 'API'], function () {
        ...
        Route::put('user/update-photo', 'UserController@updatePhoto');
        Route::put('user/update-bmi', 'UserController@updateBMI');
        ...
        Route::group(['prefix' => "sha"], function () {
            ...
            Route::put('user/{id}/about', 'ShortHealthAssessmentController@putAboutUserShortHealthHistory');
