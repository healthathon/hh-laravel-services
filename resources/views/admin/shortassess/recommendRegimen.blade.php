...
@section('main-content')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Recommended Regimen on SHA Answers</h4>
        ...
        $(function ($) {
            ...
            $("#jsGrid-basic").jsGrid({
                ...
                controller: {
                    loadData: function (item) {
                        return $.ajax({
                            method: "GET",
                            dataType: "json",
                            url: "{{url('admin/sha/recommend/page/questions/get')}}",
                ...
                fields: [
                    ...
                    {name: "header", type: "text", title: "Title"},
                    {name: "question", type: "text", title: "Query"},
                    {name: "answer", type: "text", title: "Answer"},
                    {
                        ...
                        validate: {
                            validator: "required",
                            message: function () {
                                return "Please Enter a Recommend Regimen Name";
                            }
                        }
                    },
                    {
                        name: "update_recommend_regimen",
                        type: "text",
                        width: 100,
                        css: "text-center",
                        ...
                        itemTemplate: function (item) {
                            return "<a href='" + item + "' target='_blank'>Modify Regimen Recommendation</a>";
                        }
                    }
                ],
                confirmDeleting: true,
                deleteConfirm: "Are you sure?",
                noDataContent: "No Recommended Regimen Found"
            });
        });
