...
@section('main-content')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Recommended Test on SHA Answers</h4>
                ...
                controller: {
                    loadData: function (item) {
                        return $.ajax({
                            method: "GET",
                            dataType: "json",
                            url: "{{route('admin.sha.test.recommend.question')}}",
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        itemTemplate: function (item) {
                            return "<a href='" + item + "' target='_blank'>Modify Test Recommendation</a>";
                        }
                    }
                ],
