...
@section('main-content')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Edit Nutrition Week Tasks</h4>
            ...
            $("#jsGrid-basic").jsGrid({
                ...
                controller: {
                    loadData: function(filter){
                        return $.ajax({
                            method: "GET",
                            url: "{{url('/admin/task/getNutritionWeekTask/'.$taskBank_id)}}",
                    ...
                    insertItem:function(updateItem){
                        ...
                        formData.append("week_title",updateItem.day1_title);
                        ...
                        return $.ajax({
                            method: "post",
                            url: "{{url('/admin/task/insertNutritionWeekTask')}}",
                            data: formData,
                            contentType: false,
                            processData: false,
                            dataType:'json',
                    ...
                    updateItem:function (updateItem) {
                        ...
                        return $.ajax({
                            method: "post",
                            url: "{{url('/admin/task/updateNutritionWeekTask')}}",
                            data: formData,
                            contentType: false,
                            processData: false,
                            dataType:'json',
                    ...
                    deleteItem:function (item) {
                        return $.ajax({
                            method: "post",
                            url: "{{url('/admin/task/deleteNutritionWeekTask')}}",
                            data: {
                                item,
