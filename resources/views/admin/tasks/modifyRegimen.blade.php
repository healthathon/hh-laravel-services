        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-4">Regimen for {{ $query["query"] }}</h4>
                </div>
                <div class="card-body">
...
@section('script')
    <script type="text/javascript">
        $("#modifyTestBtn").on('click', function (e) {
            ...
            $.ajax({
                method: "POST",
                url: "{{ route('admin.assess.query.answers.update') }}",
                data: {
                    _token: "{{ csrf_token() }}",
                    query_id: "{{$query["id"]}}",
                    answer: $("#answer").val(),
        ...
        $("#answer").on('change', function (e) {
            ...
            let url = "{{route('admin.assess.regimen.query.answers.get',[":queryId",":answer"])}}";
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data['status']) {
                        $("#regimenTests").html("");
                        const regimenIds = data['recommended_task'];
