...
@section('main-content')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Edit Mental Task Banks</h4>
            ...
            $("#jsGrid-basic").jsGrid({
                ...
                controller: {
                    loadData: function(filter){
                        return $.ajax({
                            method: "GET",
                            url: "{{url('admin/task/taskBank/getMentalBank')}}",
                    ...
                    insertItem:function(item){
                        return $.ajax({
                            method: "post",
                            url: "{{url('admin/task/taskBank/insertMentalBank')}}",
                            data: {
                                item,
                    ...
                    updateItem:function (item) {
                        return $.ajax({
                            method: "post",
                            url: "{{url('admin/task/taskBank/updateMentalBank')}}",
                            data: {
                                item,
                                _token : $('meta[name="csrf-token"]').attr('content'),
                            },
                    ...
                    deleteItem:function (item) {
                        return $.ajax({
                            method: "post",
                            url: "{{url('admin/task/taskBank/deleteMentalBank')}}",
                            data: {
                                item,
                                _token : $('meta[name="csrf-token"]').attr('content'),
                            },
                ...
                fields: [
                    ...
                    { name: "week_task", width: 200, css:"text-center",title:"View Weekly Tasks",align: "center",
                        itemTemplate: function(value, item) {
                            ...
                            var $link = $("<a>").attr("href", "{{url('/admin/task/showMentalWeekTask')}}"+"/"+item.ID).text("View Weekly Tasks");
