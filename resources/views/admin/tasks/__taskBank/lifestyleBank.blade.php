...
@section('main-content')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Edit Lifestyle Task Banks</h4>
            ...
            $("#jsGrid-basic").jsGrid({
                ...
                controller: {
                    loadData: function (filter) {
                        return $.ajax({
                            method: "GET",
                            url: "{{url('admin/task/taskBank/getLifestyleBank')}}",
                    ...
                    insertItem: function (item) {
                        return $.ajax({
                            method: "post",
                            url: "{{url('admin/task/taskBank/insertLifestyleBank')}}",
                            data: {
                                item,
                    ...
                    updateItem: function (item) {
                        return $.ajax({
                            method: "post",
                            url: "{{url('admin/task/taskBank/updateLifestyleBank')}}",
                            data: {
                                item,
                                _token: $('meta[name="csrf-token"]').attr('content'),
                            },
                    ...
                    deleteItem: function (item) {
                        return $.ajax({
                            method: "post",
                            url: "{{url('admin/task/taskBank/deleteLifestyleBank')}}",
                            data: {
                                item,
                                _token: $('meta[name="csrf-token"]').attr('content'),
                            },
                ...
                fields: [
                    ...
                    {name: "title", type: "text", width: 100, css: "text-center", title: "Title", align: "center"},
                    ...
                    },
                    {
                        ...
                        itemTemplate: function (value, item) {
                            ...
                            var $link = $("<a>").attr("href", "{{url('/admin/task/showLifestyleWeekTask')}}" + "/" + item.ID).text("View Weekly Tasks");
